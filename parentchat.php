...
<body >
  ...
  <div class="stick">
    ...
    <div class="topnav" id="myTopnav">
      ...
      <a href="parentchat.php" class="active">Parent Message</a>
      
      <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
    </div>
  </div>
  <div class="main">
    <h1>Send Message to Parent</h1>

<form action="parentchat.php" method="post">
...
$sql = "INSERT INTO proctormessage (Student_Id, Message) VALUES ('$_POST[Student_Id]','$_POST[Message]')";
