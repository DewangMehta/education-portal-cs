...
<body >
	<div class="stick">
      <div class="hd">
        ...
        <div class="col-usout">
        <button class="btn" onclick="window.location.href='index.php'"> Feedback </button>
      </div>
       
    </div>
  </div>
	
	<div class="shadow" style="width: 25%;margin-left: 500px;" align="center">
  		<div style = "width:100%; border-radius: 3px;  border: solid 1px #333333; background-color: lightblue; box-shadow: 5px 5px 5px grey;top:50%" align = "left" >
            <div style = "background-color:darkblue; color:#FFFFFF; padding:3px; "><b>Login</b></div>
